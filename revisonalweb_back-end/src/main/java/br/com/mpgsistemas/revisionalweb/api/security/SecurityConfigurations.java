...
public class SecurityConfigurations {
    ...
    // Origens permitidas no CORS, separadas por vírgula (env APP_CORS_ALLOWED_ORIGINS em produção)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/**").not().hasRole("VISUALIZADOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/**").not().hasRole("VISUALIZADOR")
